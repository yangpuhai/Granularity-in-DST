SEMANTIC_DICT = {
  ...
  'cheap': ['low price', 'inexpensive', 'cheaper', 'low priced', 'affordable',
            ...
            'less expensive', 'cheapeast', 'not cost an arm and a leg', 'close to broke'],
  ...
  'expensive': ['high priced', 'high end', 'high class', 'high quality', 'not some cheapie',
                'fancy', 'upscale', 'nice', 'fine dining', 'expensively', 'expensively priced'],
  ...
  'steakhouse': ['steak house', 'steak houses', 'steak'],
